...
//  Bankey
//
//  Created by Jason Hung on 2024/6/6.
//
...
extension AccountSummaryCell {
    ...
    func layout() {
        NSLayoutConstraint.activate([
            typeLabel.topAnchor.constraint(equalToSystemSpacingBelow: self.topAnchor, multiplier: 2),
            typeLabel.leadingAnchor.constraint(equalToSystemSpacingAfter: self.leadingAnchor, multiplier: 2),
            ...
            nameLabel.topAnchor.constraint(equalTo: underlineView.topAnchor, constant: 16),
